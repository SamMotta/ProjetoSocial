 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N(t){return t&&t._delegate?t._delegate:t}class F{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oe=[];var p;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(p||(p={}));const lt={debug:p.DEBUG,verbose:p.VERBOSE,info:p.INFO,warn:p.WARN,error:p.ERROR,silent:p.SILENT},hn=p.INFO,dn={[p.DEBUG]:"log",[p.VERBOSE]:"log",[p.INFO]:"info",[p.WARN]:"warn",[p.ERROR]:"error"},fn=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),s=dn[e];if(s)console[s](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ut{constructor(e){this.name=e,this._logLevel=hn,this._logHandler=fn,this._userLogHandler=null,Oe.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in p))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?lt[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,p.DEBUG,...e),this._logHandler(this,p.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,p.VERBOSE,...e),this._logHandler(this,p.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,p.INFO,...e),this._logHandler(this,p.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,p.WARN,...e),this._logHandler(this,p.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,p.ERROR,...e),this._logHandler(this,p.ERROR,...e)}}function pn(t){Oe.forEach(e=>{e.setLogLevel(t)})}function mn(t,e){for(const n of Oe){let r=null;e&&e.level&&(r=lt[e.level]),t===null?n.userLogHandler=null:n.userLogHandler=(s,i,...o)=>{const c=o.map(a=>{if(a==null)return null;if(typeof a=="string")return a;if(typeof a=="number"||typeof a=="boolean")return a.toString();if(a instanceof Error)return a.message;try{return JSON.stringify(a)}catch{return null}}).filter(a=>a).join(" ");i>=(r!=null?r:s.logLevel)&&t({level:p[i].toLowerCase(),message:c,args:o,type:s.name})}}}const gn=(t,e)=>e.some(n=>t instanceof n);let He,je;function _n(){return He||(He=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function bn(){return je||(je=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const ht=new WeakMap,Te=new WeakMap,dt=new WeakMap,be=new WeakMap,xe=new WeakMap;function yn(t){const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("success",i),t.removeEventListener("error",o)},i=()=>{n(D(t.result)),s()},o=()=>{r(t.error),s()};t.addEventListener("success",i),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&ht.set(n,t)}).catch(()=>{}),xe.set(e,t),e}function wn(t){if(Te.has(t))return;const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("complete",i),t.removeEventListener("error",o),t.removeEventListener("abort",o)},i=()=>{n(),s()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),s()};t.addEventListener("complete",i),t.addEventListener("error",o),t.addEventListener("abort",o)});Te.set(t,e)}let Ie={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return Te.get(t);if(e==="objectStoreNames")return t.objectStoreNames||dt.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return D(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function En(t){Ie=t(Ie)}function Rn(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(ye(this),e,...n);return dt.set(r,e.sort?e.sort():[e]),D(r)}:bn().includes(t)?function(...e){return t.apply(ye(this),e),D(ht.get(this))}:function(...e){return D(t.apply(ye(this),e))}}function vn(t){return typeof t=="function"?Rn(t):(t instanceof IDBTransaction&&wn(t),gn(t,_n())?new Proxy(t,Ie):t)}function D(t){if(t instanceof IDBRequest)return yn(t);if(be.has(t))return be.get(t);const e=vn(t);return e!==t&&(be.set(t,e),xe.set(e,t)),e}const ye=t=>xe.get(t);function Sn(t,e,{blocked:n,upgrade:r,blocking:s,terminated:i}={}){const o=indexedDB.open(t,e),c=D(o);return r&&o.addEventListener("upgradeneeded",a=>{r(D(o.result),a.oldVersion,a.newVersion,D(o.transaction))}),n&&o.addEventListener("blocked",()=>n()),c.then(a=>{i&&a.addEventListener("close",()=>i()),s&&a.addEventListener("versionchange",()=>s())}).catch(()=>{}),c}const Cn=["get","getKey","getAll","getAllKeys","count"],Tn=["put","add","delete","clear"],we=new Map;function ze(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(we.get(e))return we.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,s=Tn.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Cn.includes(n)))return;const i=async function(o,...c){const a=this.transaction(o,s?"readwrite":"readonly");let l=a.store;return r&&(l=l.index(c.shift())),(await Promise.all([l[n](...c),s&&a.done]))[0]};return we.set(e,i),i}En(t=>({...t,get:(e,n,r)=>ze(e,n)||t.get(e,n,r),has:(e,n)=>!!ze(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class In{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(kn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function kn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ke="@firebase/app",qe="0.7.30";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H=new ut("@firebase/app"),An="@firebase/app-compat",On="@firebase/analytics-compat",xn="@firebase/analytics",Dn="@firebase/app-check-compat",Pn="@firebase/app-check",Bn="@firebase/auth",Un="@firebase/auth-compat",Nn="@firebase/database",Ln="@firebase/database-compat",Mn="@firebase/functions",$n="@firebase/functions-compat",Fn="@firebase/installations",Hn="@firebase/installations-compat",jn="@firebase/messaging",zn="@firebase/messaging-compat",qn="@firebase/performance",Wn="@firebase/performance-compat",Vn="@firebase/remote-config",Gn="@firebase/remote-config-compat",Xn="@firebase/storage",Kn="@firebase/storage-compat",Yn="@firebase/firestore",Jn="@firebase/firestore-compat",Zn="firebase",Qn="9.9.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j="[DEFAULT]",er={[ke]:"fire-core",[An]:"fire-core-compat",[xn]:"fire-analytics",[On]:"fire-analytics-compat",[Pn]:"fire-app-check",[Dn]:"fire-app-check-compat",[Bn]:"fire-auth",[Un]:"fire-auth-compat",[Nn]:"fire-rtdb",[Ln]:"fire-rtdb-compat",[Mn]:"fire-fn",[$n]:"fire-fn-compat",[Fn]:"fire-iid",[Hn]:"fire-iid-compat",[jn]:"fire-fcm",[zn]:"fire-fcm-compat",[qn]:"fire-perf",[Wn]:"fire-perf-compat",[Vn]:"fire-rc",[Gn]:"fire-rc-compat",[Xn]:"fire-gcs",[Kn]:"fire-gcs-compat",[Yn]:"fire-fst",[Jn]:"fire-fst-compat","fire-js":"fire-js",[Zn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(t){K(new F("platform-logger",e=>new In(e),"PRIVATE")),K(new F("heartbeat",e=>new dr(e),"PRIVATE")),P(ke,qe,t),P(ke,qe,"esm2017"),P("fire-js","")}mr("");const gr=Object.freeze(Object.defineProperty({__proto__:null,SDK_VERSION:De,_DEFAULT_ENTRY_NAME:j,_addComponent:ae,_addOrOverwriteComponent:ft,_apps:B,_clearComponents:nr,_components:ee,_getProvider:pt,_registerComponent:K,_removeServiceInstance:tr,deleteApp:gt,getApp:ir,getApps:or,initializeApp:mt,onLog:_t,registerVersion:P,setLogLevel:bt,FirebaseError:q},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 ...
 */if(Jt()&&self.firebase!==void 0){Ke.warn(`
  ...
  `);const t=self.firebase.SDK_VERSION;t&&t.indexOf("LITE")>=0&&Ke.warn(`
    ...
    `)}const ue=wr;vr();var Sr="firebase",Cr="9.9.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ue.registerVersion(Sr,Cr,"app-compat");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt="firebasestorage.googleapis.com",vt="storageBucket",Tr=2*60*1e3,Ir=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}function Re(t){return"storage/"+t}function Pe(){const t="An unknown error occurred, please check the error payload for server response.";return new m("unknown",t)}function kr(t){return new m("object-not-found","Object '"+t+"' does not exist.")}function Ar(t){return new m("quota-exceeded","Quota for bucket '"+t+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function Or(){const t="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new m("unauthenticated",t)}function xr(){return new m("unauthorized-app","This app does not have permission to access Firebase Storage on this project.")}function Dr(t){return new m("unauthorized","User does not have permission to access '"+t+"'.")}function Pr(){return new m("retry-limit-exceeded","Max retry time for operation exceeded, please try again.")}function St(){return new m("canceled","User canceled the upload/download.")}function Br(t){return new m("invalid-url","Invalid URL '"+t+"'.")}function Ur(t){return new m("invalid-default-bucket","Invalid default bucket '"+t+"'.")}function Nr(){return new m("no-default-bucket","No default bucket found. Did you set the '"+vt+"' property when initializing the app?")}function Ct(){return new m("cannot-slice-blob","Cannot slice blob for upload. Please retry the upload.")}function Lr(){return new m("server-file-wrong-size","Server recorded incorrect upload file size, please retry the upload.")}function Mr(){return new m("no-download-url","The given file does not have any download URLs.")}function X(t){return new m("invalid-argument",t)}function Tt(){return new m("app-deleted","The Firebase app was deleted.")}function It(t){return new m("invalid-root-operation","The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Q(t,e){return new m("invalid-format","String does not match format '"+t+"': "+e)}function Z(t){throw new m("internal-error","Internal error: "+t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jr(t){return t!==void 0}function zr(t){return typeof t=="function"}function qr(t){return typeof t=="object"&&!Array.isArray(t)}function he(t){return typeof t=="string"||t instanceof String}function Ye(t){return Be()&&t instanceof Blob}function Be(){return typeof Blob<"u"}function Ae(t,e,n,r){if(r<e)throw X(`Invalid value for '${t}'. Expected ${e} or greater.`);if(r>n)throw X(`Invalid value for '${t}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L(t,e,n){let r=e;return n==null&&(r=`https://${e}`),`${n}://${r}/v0${t}`}function kt(t){const e=encodeURIComponent;let n="?";for(const r in t)if(t.hasOwnProperty(r)){const s=e(r)+"="+e(t[r]);n=n+s+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wr{constructor(e,n,r,s,i,o,c,a,l,u,h){this.url_=e,this.method_=n,this.headers_=r,this.body_=s,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=c,this.errorCallback_=a,this.timeout_=l,this.progressCallback_=u,this.connectionFactory_=h,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((d,f)=>{this.resolve_=d,this.reject_=f,this.start_()})}start_(){const e=(r,s)=>{if(s){r(!1,new ne(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=c=>{const a=c.loaded,l=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(a,l)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const c=i.getErrorCode()===$.NO_ERROR,a=i.getStatus();if(!c||this.isRetryStatusCode_(a)){const u=i.getErrorCode()===$.ABORT;r(!1,new ne(!1,null,u));return}const l=this.successCodes_.indexOf(a)!==-1;r(!0,new ne(l,i))})},n=(r,s)=>{const i=this.resolve_,o=this.reject_,c=s.connection;if(s.wasSuccessCode)try{const a=this.callback_(c,c.getResponse());jr(a)?i(a):i()}catch(a){o(a)}else if(c!==null){const a=Pe();a.serverResponse=c.getErrorText(),this.errorCallback_?o(this.errorCallback_(c,a)):o(a)}else if(s.canceled){const a=this.appDelete_?Tt():St();o(a)}else{const a=Pr();o(a)}};this.canceled_?n(!1,new ne(!1,null,!0)):this.backoffId_=Fr(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&Hr(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}isRetryStatusCode_(e){const n=e>=500&&e<600,s=[408,429].indexOf(e)!==-1,i=this.additionalRetryCodes_.indexOf(e)!==-1;return n||s||i}}class ne{constructor(e,n,r){this.wasSuccessCode=e,this.connection=n,this.canceled=!!r}}function Vr(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function Gr(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e!=null?e:"AppManager")}function Xr(t,e){e&&(t["X-Firebase-GMPID"]=e)}function Kr(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function Yr(t,e,n,r,s,i){const o=kt(t.urlParams),c=t.url+o,a=Object.assign({},t.headers);return Xr(a,e),Vr(a,n),Gr(a,i),Kr(a,r),new Wr(c,t.method,a,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class ve{constructor(e,n){this.data=e,this.contentType=n||null}}function At(t,e){switch(t){case S.RAW:return new ve(Ot(e));case S.BASE64:case S.BASE64URL:return new ve(xt(t,e));case S.DATA_URL:return new ve(ns(e),rs(e))}throw Pe()}function Ot(t){const e=[];for(let n=0;n<t.length;n++){let r=t.charCodeAt(n);if(r<=127)e.push(r);else if(r<=2047)e.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(n<t.length-1&&(t.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const i=r,o=t.charCodeAt(++n);r=65536|(i&1023)<<10|o&1023,e.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?e.push(239,191,189):e.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(e)}function ts(t){let e;try{e=decodeURIComponent(t)}catch{throw Q(S.DATA_URL,"Malformed data URL.")}return Ot(e)}function xt(t,e){switch(t){case S.BASE64:{const s=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(s||i)throw Q(t,"Invalid character '"+(s?"-":"_")+"' found: is it base64url encoded?");break}case S.BASE64URL:{const s=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(s||i)throw Q(t,"Invalid character '"+(s?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=es(e)}catch{throw Q(t,"Invalid character found")}const r=new Uint8Array(n.length);for(let s=0;s<n.length;s++)r[s]=n.charCodeAt(s);return r}class Dt{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw Q(S.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=n[1]||null;r!=null&&(this.base64=ss(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=e.substring(e.indexOf(",")+1)}}function ns(t){const e=new Dt(t);return e.base64?xt(S.BASE64,e.rest):ts(e.rest)}function rs(t){return new Dt(t).contentType}function ss(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class A{constructor(e,n){let r=0,s="";Ye(e)?(this.data_=e,r=e.size,s=e.type):e instanceof ArrayBuffer?(n?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),r=this.data_.length):e instanceof Uint8Array&&(n?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),r=e.length),this.size_=r,this.type_=s}size(){return this.size_}type(){return this.type_}slice(e,n){if(Ye(this.data_)){const r=this.data_,s=Qr(r,e,n);return s===null?null:new A(s)}else{const r=new Uint8Array(this.data_.buffer,e,n-e);return new A(r,!0)}}static getBlob(...e){if(Be()){const n=e.map(r=>r instanceof A?r.data_:r);return new A(Zr.apply(null,n))}else{const n=e.map(o=>he(o)?At(S.RAW,o).data:o.data_);let r=0;n.forEach(o=>{r+=o.byteLength});const s=new Uint8Array(r);let i=0;return n.forEach(o=>{for(let c=0;c<o.length;c++)s[i++]=o[c]}),new A(s,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function is(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function os(t,e){const n=e.split("/").filter(r=>r.length>0).join("/");return t.length===0?n:t+"/"+n}function Pt(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T(t){if(!t)throw Pe()}function fe(t,e){function n(r,s){const i=Bt(t,s,e);return T(i!==null),i}return n}function ps(t,e){function n(r,s){const i=fs(t,e,s);return T(i!==null),i}return n}function ms(t,e){function n(r,s){const i=Bt(t,s,e);return T(i!==null),hs(i,s,t.host,t._protocol)}return n}function Y(t){function e(n,r){let s;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?s=xr():s=Or():n.getStatus()===402?s=Ar(t.bucket):n.getStatus()===403?s=Dr(t.path):s=r,s.serverResponse=r.serverResponse,s}return e}function pe(t){const e=Y(t);function n(r,s){let i=e(r,s);return r.getStatus()===404&&(i=kr(t.path)),i.serverResponse=s.serverResponse,i}return n}function Ut(t,e,n){const r=e.fullServerUrl(),s=L(r,t.host,t._protocol),i="GET",o=t.maxOperationRetryTime,c=new x(s,i,fe(t,n),o);return c.errorHandler=pe(e),c}function gs(t,e,n,r,s){const i={};e.isRoot?i.prefix="":i.prefix=e.path+"/",n&&n.length>0&&(i.delimiter=n),r&&(i.pageToken=r),s&&(i.maxResults=s);const o=e.bucketOnlyServerUrl(),c=L(o,t.host,t._protocol),a="GET",l=t.maxOperationRetryTime,u=new x(c,a,ps(t,e.bucket),l);return u.urlParams=i,u.errorHandler=Y(e),u}function _s(t,e,n){const r=e.fullServerUrl(),s=L(r,t.host,t._protocol),i="GET",o=t.maxOperationRetryTime,c=new x(s,i,ms(t,n),o);return c.errorHandler=pe(e),c}function bs(t,e,n,r){const s=e.fullServerUrl(),i=L(s,t.host,t._protocol),o="PATCH",c=Ne(n,r),a={"Content-Type":"application/json; charset=utf-8"},l=t.maxOperationRetryTime,u=new x(i,o,fe(t,r),l);return u.headers=a,u.body=c,u.errorHandler=pe(e),u}function ys(t,e){const n=e.fullServerUrl(),r=L(n,t.host,t._protocol),s="DELETE",i=t.maxOperationRetryTime;function o(a,l){}const c=new x(r,s,o,i);return c.successCodes=[200,204],c.errorHandler=pe(e),c}function ws(t,e){return t&&t.contentType||e&&e.type()||"application/octet-stream"}function Nt(t,e,n){const r=Object.assign({},n);return r.fullPath=t.path,r.size=e.size(),r.contentType||(r.contentType=ws(null,e)),r}function Es(t,e,n,r,s){const i=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let y="";for(let b=0;b<2;b++)y=y+Math.random().toString().slice(2);return y}const a=c();o["Content-Type"]="multipart/related; boundary="+a;const l=Nt(e,r,s),u=Ne(l,n),h="--"+a+`\r
...
\r
`,d=`\r
--`+a+"--",f=A.getBlob(h,r,d);if(f===null)throw Ct();const _={name:l.fullPath},v=L(i,t.host,t._protocol),g="POST",I=t.maxUploadRetryTime,k=new x(v,g,fe(t,n),I);return k.urlParams=_,k.headers=o,k.body=f.uploadData(),k.errorHandler=Y(e),k}class ce{constructor(e,n,r,s){this.current=e,this.total=n,this.finalized=!!r,this.metadata=s||null}}function Le(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{T(!1)}return T(!!n&&(e||["active"]).indexOf(n)!==-1),n}function Rs(t,e,n,r,s){const i=e.bucketOnlyServerUrl(),o=Nt(e,r,s),c={name:o.fullPath},a=L(i,t.host,t._protocol),l="POST",u={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},h=Ne(o,n),d=t.maxUploadRetryTime;function f(v){Le(v);let g;try{g=v.getResponseHeader("X-Goog-Upload-URL")}catch{T(!1)}return T(he(g)),g}const _=new x(a,l,f,d);return _.urlParams=c,_.headers=u,_.body=h,_.errorHandler=Y(e),_}function vs(t,e,n,r){const s={"X-Goog-Upload-Command":"query"};function i(l){const u=Le(l,["active","final"]);let h=null;try{h=l.getResponseHeader("X-Goog-Upload-Size-Received")}catch{T(!1)}h||T(!1);const d=Number(h);return T(!isNaN(d)),new ce(d,r.size(),u==="final")}const o="POST",c=t.maxUploadRetryTime,a=new x(n,o,i,c);return a.headers=s,a.errorHandler=Y(e),a}const Qe=256*1024;function Ss(t,e,n,r,s,i,o,c){const a=new ce(0,0);if(o?(a.current=o.current,a.total=o.total):(a.current=0,a.total=r.size()),r.size()!==a.total)throw Lr();const l=a.total-a.current;let u=l;s>0&&(u=Math.min(u,s));const h=a.current,d=h+u,_={"X-Goog-Upload-Command":u===l?"upload, finalize":"upload","X-Goog-Upload-Offset":`${a.current}`},v=r.slice(h,d);if(v===null)throw Ct();function g(b,W){const V=Le(b,["active","final"]),me=a.current+u,J=r.size();let ge;return V==="final"?ge=fe(e,i)(b,W):ge=null,new ce(me,J,V==="final",ge)}const I="POST",k=e.maxUploadRetryTime,y=new x(n,I,g,k);return y.headers=_,y.body=v.uploadData(),y.progressCallback=c||null,y.errorHandler=Y(t),y}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cs={STATE_CHANGED:"state_changed"},R={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function Se(t){switch(t){case"running":case"pausing":case"canceling":return R.RUNNING;case"paused":return R.PAUSED;case"success":return R.SUCCESS;case"canceled":return R.CANCELED;case"error":return R.ERROR;default:return R.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class z{constructor(e,n){this._service=e,n instanceof w?this._location=n:this._location=w.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new z(e,n)}get root(){const e=new w(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Pt(this._location.path)}get storage(){return this._service}get parent(){const e=is(this._location.path);if(e===null)return null;const n=new w(this._location.bucket,e);return new z(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw It(e)}}function As(t,e,n){return t._throwIfRoot("uploadBytesResumable"),new Lt(t,new A(e),n)}function Os(t){const e={prefixes:[],items:[]};return Mt(t,e).then(()=>e)}async function Mt(t,e,n){const s=await $t(t,{pageToken:n});e.prefixes.push(...s.prefixes),e.items.push(...s.items),s.nextPageToken!=null&&await Mt(t,e,s.nextPageToken)}function $t(t,e){e!=null&&typeof e.maxResults=="number"&&Ae("options.maxResults",1,1e3,e.maxResults);const n=e||{},r=gs(t.storage,t._location,"/",n.pageToken,n.maxResults);return t.storage.makeRequestWithTokens(r,C)}function xs(t){t._throwIfRoot("getMetadata");const e=Ut(t.storage,t._location,de());return t.storage.makeRequestWithTokens(e,C)}function Ds(t,e){t._throwIfRoot("updateMetadata");const n=bs(t.storage,t._location,e,de());return t.storage.makeRequestWithTokens(n,C)}function Ps(t){t._throwIfRoot("getDownloadURL");const e=_s(t.storage,t._location,de());return t.storage.makeRequestWithTokens(e,C).then(n=>{if(n===null)throw Mr();return n})}function Bs(t){t._throwIfRoot("deleteObject");const e=ys(t.storage,t._location);return t.storage.makeRequestWithTokens(e,C)}function Ft(t,e){const n=os(t._location.path,e),r=new w(t._location.bucket,n);return new z(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $s="storage";function Fs(t,e,n){return t=N(t),As(t,e,n)}function Hs(t){return t=N(t),xs(t)}function js(t,e){return t=N(t),Ds(t,e)}function zs(t,e){return t=N(t),$t(t,e)}function qs(t){return t=N(t),Os(t)}function Ws(t){return t=N(t),Ps(t)}function Vs(t){return t=N(t),Bs(t)}function rt(t,e){return t=N(t),Ls(t,e)}function Gs(t,e){return Ft(t,e)}function Xs(t,e,n,r={}){Ms(t,e,n,r)}function Ks(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new Me(n,r,s,e,De)}function Ys(){K(new F($s,Ks,"PUBLIC").setMultipleInstances(!0)),P(tt,nt,""),P(tt,nt,"esm2017")}Ys();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O{constructor(e,n){this._delegate=e,this.storage=n}get name(){return this._delegate.name}get bucket(){return this._delegate.bucket}get fullPath(){return this._delegate.fullPath}toString(){return this._delegate.toString()}child(e){const n=Gs(this._delegate,e);return new O(n,this.storage)}get root(){return new O(this._delegate.root,this.storage)}get parent(){const e=this._delegate.parent;return e==null?null:new O(e,this.storage)}put(e,n){return this._throwIfRoot("put"),new st(Fs(this._delegate,e,n),this)}putString(e,n=S.RAW,r){this._throwIfRoot("putString");const s=At(n,e),i=Object.assign({},r);return i.contentType==null&&s.contentType!=null&&(i.contentType=s.contentType),new st(new Lt(this._delegate,new A(s.data,!0),i),this)}listAll(){return qs(this._delegate).then(e=>new it(e,this.storage))}list(e){return zs(this._delegate,e||void 0).then(n=>new it(n,this.storage))}getMetadata(){return Hs(this._delegate)}updateMetadata(e){return js(this._delegate,e)}getDownloadURL(){return Ws(this._delegate)}delete(){return this._throwIfRoot("delete"),Vs(this._delegate)}_throwIfRoot(e){if(this._delegate._location.path==="")throw It(e)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt{constructor(e,n){this.app=e,this._delegate=n}get maxOperationRetryTime(){return this._delegate.maxOperationRetryTime}get maxUploadRetryTime(){return this._delegate.maxUploadRetryTime}ref(e){if(ot(e))throw X("ref() expected a child path but got a URL, use refFromURL instead.");return new O(rt(this._delegate,e),this)}refFromURL(e){if(!ot(e))throw X("refFromURL() expected a full URL but got a child path, use ref() instead.");try{w.makeFromUrl(e,this._delegate.host)}catch{throw X("refFromUrl() expected a valid full URL but got an invalid one.")}return new O(rt(this._delegate,e),this)}setMaxUploadRetryTime(e){this._delegate.maxUploadRetryTime=e}setMaxOperationRetryTime(e){this._delegate.maxOperationRetryTime=e}useEmulator(e,n,r={}){Xs(this._delegate,e,n,r)}}function ot(t){return/^[A-Za-z]+:\/\//.test(t)}const Js="@firebase/storage-compat",Zs="0.1.17";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
