 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H=new ut("@firebase/app"),kn="@firebase/app-compat",Dn="@firebase/analytics-compat",On="@firebase/analytics",Pn="@firebase/app-check-compat",xn="@firebase/app-check",Bn="@firebase/auth",Un="@firebase/auth-compat",Nn="@firebase/database",Ln="@firebase/database-compat",Mn="@firebase/functions",$n="@firebase/functions-compat",Fn="@firebase/installations",Hn="@firebase/installations-compat",jn="@firebase/messaging",zn="@firebase/messaging-compat",qn="@firebase/performance",Vn="@firebase/performance-compat",Wn="@firebase/remote-config",Gn="@firebase/remote-config-compat",Xn="@firebase/storage",Kn="@firebase/storage-compat",Yn="@firebase/firestore",Jn="@firebase/firestore-compat",Zn="firebase",Qn="9.9.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j="[DEFAULT]",er={[Ae]:"fire-core",[kn]:"fire-core-compat",[On]:"fire-analytics",[Dn]:"fire-analytics-compat",[xn]:"fire-app-check",[Pn]:"fire-app-check-compat",[Bn]:"fire-auth",[Un]:"fire-auth-compat",[Nn]:"fire-rtdb",[Ln]:"fire-rtdb-compat",[Mn]:"fire-fn",[$n]:"fire-fn-compat",[Fn]:"fire-iid",[Hn]:"fire-iid-compat",[jn]:"fire-fcm",[zn]:"fire-fcm-compat",[qn]:"fire-perf",[Vn]:"fire-perf-compat",[Wn]:"fire-rc",[Gn]:"fire-rc-compat",[Xn]:"fire-gcs",[Kn]:"fire-gcs-compat",[Yn]:"fire-fst",[Jn]:"fire-fst-compat","fire-js":"fire-js",[Zn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L(t,e,n){let r=e;return n==null&&(r=`https://${e}`),`${n}://${r}/v0${t}`}function At(t){const e=encodeURIComponent;let n="?";for(const r in t)if(t.hasOwnProperty(r)){const s=e(r)+"="+e(t[r]);n=n+s+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,d=`\r
--`+a+"--",f=k.getBlob(h,r,d);if(f===null)throw Ct();const _={name:l.fullPath},S=L(i,t.host,t._protocol),g="POST",I=t.maxUploadRetryTime,A=new O(S,g,fe(t,n),I);return A.urlParams=_,A.headers=o,A.body=f.uploadData(),A.errorHandler=Y(e),A}class ce{constructor(e,n,r,s){this.current=e,this.total=n,this.finalized=!!r,this.metadata=s||null}}function Le(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{T(!1)}return T(!!n&&(e||["active"]).indexOf(n)!==-1),n}function Rs(t,e,n,r,s){const i=e.bucketOnlyServerUrl(),o=Nt(e,r,s),c={name:o.fullPath},a=L(i,t.host,t._protocol),l="POST",u={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},h=Ne(o,n),d=t.maxUploadRetryTime;function f(S){Le(S);let g;try{g=S.getResponseHeader("X-Goog-Upload-URL")}catch{T(!1)}return T(he(g)),g}const _=new O(a,l,f,d);return _.urlParams=c,_.headers=u,_.body=h,_.errorHandler=Y(e),_}function Ss(t,e,n,r){const s={"X-Goog-Upload-Command":"query"};function i(l){const u=Le(l,["active","final"]);let h=null;try{h=l.getResponseHeader("X-Goog-Upload-Size-Received")}catch{T(!1)}h||T(!1);const d=Number(h);return T(!isNaN(d)),new ce(d,r.size(),u==="final")}const o="POST",c=t.maxUploadRetryTime,a=new O(n,o,i,c);return a.headers=s,a.errorHandler=Y(e),a}const Qe=256*1024;function vs(t,e,n,r,s,i,o,c){const a=new ce(0,0);if(o?(a.current=o.current,a.total=o.total):(a.current=0,a.total=r.size()),r.size()!==a.total)throw Lr();const l=a.total-a.current;let u=l;s>0&&(u=Math.min(u,s));const h=a.current,d=h+u,_={"X-Goog-Upload-Command":u===l?"upload, finalize":"upload","X-Goog-Upload-Offset":`${a.current}`},S=r.slice(h,d);if(S===null)throw Ct();function g(b,V){const W=Le(b,["active","final"]),me=a.current+u,J=r.size();let ge;return W==="final"?ge=fe(e,i)(b,V):ge=null,new ce(me,J,W==="final",ge)}const I="POST",A=e.maxUploadRetryTime,y=new O(n,I,g,A);return y.headers=_,y.body=S.uploadData(),y.progressCallback=c||null,y.errorHandler=Y(t),y}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
